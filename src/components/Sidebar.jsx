...
export function Sidebar() {
  ...
  return (
    <aside className="flex flex-col gap-5 bg-yellow-400 min-w-72 w-2/12 items-center">
      <div className={`flex justify-center items-center gap-2 bg-yellow-400 text-black px-1 py-5 h-16 text-2xl font-black`}>
        <span className="border-l-yellow-600 border-l-8 px-2">CRUD OPERATIONS</span>
      </div>

      <div className="mb-20 flex flex-col bg-yellow-400 min-w-72 w-2/12 items-center">
        <img src={xandis} alt="picture" className=" w-1/2 rounded-full"/>
        <strong className="w-full text-center mt-3">Xandis</strong>
        <p className="text-zinc-600 text-sm ">Admin</p>
      </div>
