...
export function Sidebar() {
  ...
  return (
    <aside className="flex flex-col gap-5 bg-red-100 min-w-72 w-2/12 items-center">
      ...
      <nav className={`flex flex-col justify-start items-center gap-2 w-3/4 h-full`}>
        ...
        <NavLink to="/" className= "flex items-center justify-center gap-3 py-2 w-full rounded text-sm text-black hover:bg-zinc-400 ">
          Deslogar
