...
export function Home() {
    return (
        <div className="overflow-hidden h-full w-full  ">
            ...
            <header className=" font-sans p-4 flex w-full justify-between items-center">
            ...
            <main className="flex justify-around p-8 ">
                ...
                <div className="text-right p-6 w-80 h-48 rounded-lg bg-sky-100">
                    <div className="text-left h-24">
                        ...
                        <p className="text-slate-500"> Estudantes </p>
                    </div>
                    <span className="text-4xl"> <strong> 22 </strong> </span>
                ...
                <div className="text-right p-6 w-80 h-48 rounded-lg bg-yellow-100">
                    <div className="text-left h-24">
                        ...
                        <p className="text-slate-500"> Pagamentos </p>
                    </div>
                    <span className="text-4xl"><strong className="text-xl">R$</strong> <strong> 2.000 </strong> </span>

                </div>

                {/* Card 4 */}

                <div className="text-right p-6 w-80 h-48 rounded-lg  bg-amber-300 bg-gradient-to-r from-amber-500	 ">
                    <div className="text-left h-24">
